...
/**
 * Source unique de vérité pour l'identité visuelle de chaque module
 * (icône + couleur dédiées). Utilisée par EnTetePageComponent (en-tête de
 * chaque page) et par le widget "Raccourcis" du tableau de bord, pour que
 * l'association module <-> couleur reste cohérente partout dans l'app.
 *
